...
def update_profile(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            updated = True
            form = UserProfileChange(instance=current_user)
    return render(request, 'App_Login/update_profile.html', context={'form':form, 'updated':updated})
...
def add_pro_pic(request):
    ...
    return render(request, 'App_Login/update_pro_pic.html', context={'form':form})
